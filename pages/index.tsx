            ...
            <div className="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
              ...
              <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                ...
                <p className="mt-6 max-w-lg mx-auto text-center text-xl text-sky-200 sm:max-w-3xl">
                  Zostań produktywnym kosztorystanem/tką. Poruszaj się sprawnie
                  po programie, stosuj najlepsze praktyki. Zoszczędź czas oraz
                  unikaj potencjalnych błędów, które mogą kosztować{" "}
            ...
            <div className="mt-6 grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5">
              <div className="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
                <img
                  ...
                  src="https://upload.wikimedia.org/wikipedia/commons/c/c4/Polska_Grupa_Energetyczna_logo.svg"
                  alt="Tuple"
                />
              </div>
              <div className="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
                <img
                  className="h-12 grayscale "
                  src="https://www.absolvent.pl/storage/employers/logo-pkp-energetyka.svg/PckVwACNrob3kKJPMq7XCXinf8REQWOz3rlbjeCQ.svg"
                  alt="Mirage"
                />
              </div>
              <div className="col-span-1 flex justify-center md:col-span-2 lg:col-span-1">
                ...
                <div>
                  ...
                  <div className="mt-6">
                    ...
                    <p className="mt-4 text-lg text-gray-500">
                      ...
                      tysiącą kosztorysantą. Szkolimy w całej polsce, jednak
                      obecnei skupiamy się na <strong>zdalnych</strong>{" "}
                      szkoleniach.
                    </p>
                    <div className="mt-6">
                      <a
                  ...
                  <blockquote>
                    <div>
                      <p className="text-base text-gray-500">
                        ...
                        Widzę że popełniamy mniej błędów, które były zbyt drogie
                        dla mojego biznesu.&rdquo;
                      </p>
                    </div>
                    <footer className="mt-3">
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="text-base font-medium text-gray-700">
                          Justyna Kowalska, Preses Biura Projektowego Kowalscy
                          Sp. z o.o.
                        </div>
                      </div>
                    </footer>
        ...
        <div className="bg-gradient-to-r from-blue-800 to-sky-700">
          <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 sm:pt-20 sm:pb-24 lg:max-w-7xl lg:pt-24 lg:px-8">
            ...
            <p className="mt-4 max-w-3xl text-lg text-blue-200">
              Ceny oprogramowania są stałe, niezależnie od firmy. Ceny szkoleń
              również wachają się w podobnym zakresie. Więc dlaczego wybrać nas?
            </p>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8 xl:grid xl:grid-cols-2 xl:grid-flow-col-dense xl:gap-x-8">
            <div className="relative pt-12 pb-64 sm:pt-24 sm:pb-64 xl:col-start-1 xl:pb-24">
              ...
              <p className="mt-5 text-lg text-gray-300">
                Regularnie moniturujemy zadowolenie naszych klientów. Jesteśmy
                dumni z danych które zbieramy. Jednak nie osiadamy na laurach i
                codziennie zastanawiamy sie jak możemy polepszyć nasze usługi
              </p>
          ...
          <div className="max-w-4xl mx-auto py-16 px-4 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8 lg:flex lg:items-center lg:justify-between">
            <h2 className="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
              <span className="block">
                Gotów by zwiększyć swoje kompentecje?
              </span>
        ...
        <div className="max-w-7xl mx-auto pt-16 pb-8 px-4 sm:px-6 lg:pt-24 lg:px-8">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div className="mt-12 xl:mt-0">
              ...
              <p className="mt-4 text-base text-gray-500">
                Raz na dwa tygodnie przesyłamy tipy dotyczące lepszego używania
                oprogramowania do kosztorysowania
              </p>
              <form className="mt-4 sm:flex sm:max-w-md">
                ...
                <div className="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
                  <button
                    type="submit"
                    className="w-full flex items-center justify-center bg-gradient-to-r from-blue-600 to-sky-600 bg-origin-border px-4 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white hover:from-blue-700 hover:to-sky-700"
                  >
                    Zapisz się
                  </button>
                </div>
          ...
          <div className="mt-12 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between lg:mt-16">
            ...
            <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
              &copy; 2022 PartnerSoft.pl, Wszystkie prawa zastrzeżone.
            </p>
          </div>
        </div>
      </footer>
